...
SELECT id, user_id, reserved_at, is_processed FROM coupon_reservations WHERE user_id = $1 LIMIT 1
`
...
SELECT id, user_id, reserved_at, is_processed FROM coupon_reservations WHERE reserved_at BETWEEN $1 AND $2 AND is_processed = FALSE FOR UPDATE SKIP LOCKED
`
...
SELECT id, user_id, reserved_at, is_processed FROM coupon_reservations WHERE user_id = $1 AND reserved_at BETWEEN $2 AND $3 AND is_processed = TRUE
`
...
SELECT id, user_id, reserved_at, is_processed FROM coupon_reservations WHERE is_processed = FALSE ORDER BY id FOR UPDATE SKIP LOCKED
`
...
SELECT id, user_id, reserved_at, is_processed FROM coupon_reservations WHERE is_processed = FALSE ORDER BY id LIMIT $1 FOR UPDATE SKIP LOCKED
`
