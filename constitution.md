# shop_coupon 项目开发宪法
# Version: 1.0, Ratified: 2026-02-13
...
- **1.2 (标准库优先):** 必须优先使用Go标准库。**例外：** Web框架允许使用`gin-gonic/gin`，因其提供路由分组、中间件链、请求参数绑定与验证等功能，显著降低了手动实现的复杂度。
...
- **3.3 :** 所有的 commit 不要將 claude 列為作者。
